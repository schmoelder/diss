...
For the equilibrium constant, {glue:text}`k_eq` is again close to Ladiwala et al. (0.0763), but lower than the value measured by Osberghaus et al. (0.118).  @todo: add units
