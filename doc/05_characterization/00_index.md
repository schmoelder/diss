...
- **Void volume estimation**: Acetone and salt tracers are used to estimate the void volume of the injection valve, the tubing before and after the column, as well as the tubing between the detectors.
