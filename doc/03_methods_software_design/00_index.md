...
This can lead to a lack of awareness of techniques and practices that may exist to improve the quality of code {cite}`Hannay2009`.
...
Specifically, programming principles, object-oriented design, documentation, and testing are discussed, along with version control, CI/CD pipelines, software licensing, and research data management.
