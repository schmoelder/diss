...
During the preparation of this work, the author used OpenAI ChatGPT, Mistral Le Chat, and Anthropic Claude in order to draft and revise prose from the author's own content specifications, to expand transitions and chapter introductions, and to improve readability and language.
For code, the same tools assisted with formatting, docstrings, and type annotations, with debugging, and with adjusting figure layouts.
The models, studies, results, and their interpretation were not generated by these tools.
After using these tools, the manuscript was reviewed and edited by the author, who takes full responsibility for the content of this dissertation.
